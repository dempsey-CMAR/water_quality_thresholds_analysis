...
**say that outliers and freshwater, etc. removed**

**show ALL temperature stations and then those that were used for the analysis - maybe as different layers**

**add climatology vs. user threshold plot**
