...
# summarized data 
dat <- read_csv(
  here("data/3_summary_filtered_data_shallow.csv"), show_col_types = FALSE
) %>% 
...
- Only data from <= 6m considered (> 67 % of obs).
...
- Very minor differences in mean, stdev, and user thresholds compared to filtered data.
...
- Colchester: data from June to December was collected in 2020 and 2021; data from January to May was collected in 2022 (see Colchester figure in Climatology subsection) 
