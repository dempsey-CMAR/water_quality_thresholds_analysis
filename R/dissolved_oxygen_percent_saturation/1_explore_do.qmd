...
- 4 counties have only 1 station with dissolved oxygen data: Antigonish, Colchester, Queens, and Richmond.
...
- Inverness: includes dissolved oxygen data from depth (below the oxycline) in Whycocomagh Basin (18 m and 40 m at Deep Basin, 28 m at Aberdeen, and 17 m at 0814x East and West).
...
- Measurements at 8, 18, 28, and 26 m are all from Whycocomagh Basin (on and below the oxycline).
...
- Fewest dissolved oxygen observations in the spring and summer, likely due to biofouling.
- Some evidence of climatological cycle within counties; Inverness and Pictou driven by outlying stations (Whycocomagh Basin and Piper Lake).
