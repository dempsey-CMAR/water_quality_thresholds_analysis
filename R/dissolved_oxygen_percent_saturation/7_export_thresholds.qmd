...
- most of this section might get pulled into a broader Coastal Monitoring Program section
- less intuitive than other variables like temperature
...
There is some monthly and overall variability between counties, although it is typically small. Difficult to parse whether it is true differences based on location or a result of missing data
