...
dat <- read_csv(
  here("data/5_summary_filtered_data_sal_no_inverness.csv"), 
...
- Additional QC was applied based on review of 1.1_explore_sal.html and 0.1_sal_additional_qc.html
  ...
  - Inverness data not included (deployed in brackish water and recorded 5 x more often than other sensors)
...
- Antigonish is noticeably lower than the other counties. It is in a relatively sheltered area; potentially more impacted by freshwater runoff.
...
- No observations for January or December.
- Very high standard deviation for June, July.
...
- Very different signals for each county.
...
- No data for January or December.
- Limited data (< 10,000 obs) for 5 months.
- Not enough data for climatology thresholds; use user_thresholds instead.
