...
dat <- read_csv(
  here("data/6_summary_filtered_data_sal_inverness.csv"), 
...
- Decrease could be sensor drift, but it seems to track changes in temperature (see sal_additional_qc.html).
