...
- More observations in September, Octoeberm and November because the sensors in Inverness recorded every 2 minutes.
...
- Drop in 2019 and 2020 is likely due to biofouling. Deployments should be reviewed for additional QC prior to calculating thresholds.
...
- Antigonish, Guysborough, and Yarmouth are the only counties with salinity observations for all 12 months.
...
- Review Antigonish (2021), Digby (2021), Guysborough (2020 and 2019), and Yarmouth for biofouling.

# Recommendations for Additional QC

- Apply additional QC to remove suspected drift from biofouling.
