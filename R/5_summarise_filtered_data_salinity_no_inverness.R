...
# Filters out Inverness data because it is a brackish area and because
# these sensors recorded every 2 minutes
# (rather than every 10 minutes like most other sensors)
...
write_csv(dat_out, here("data/5_summary_filtered_data_sal_no_inverness.csv"))
