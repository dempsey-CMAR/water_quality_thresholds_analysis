...
dat <- read_csv(here("data/8_summary_filtered_data_depth.csv"), show_col_types = FALSE) %>%
...
- Filtered data is based on 0.1_depth_additional_qc.html and 1.1_explore_depth_html
  ...
  - Olding Island 2022-06-03 sensor at 3 m did not record properly and was removed.
  - Long Beach and Sandy Cove (2020-Jul-16) 2 m data was removed because of very high tidal range relative to other deployments in the area.
      - Likely that the strings were pushed over with the tide.
  - Tickle Island (2020-Oct-21) 5m data removed because of very high tidal range relative to other deployments in the area.
    - Potential biofouling weighing down the string.

- The estimated sensor depth was NOT rounded. 
...
- Most observations from Guysborough, then Halifax, Lunenburg, and Shelburne.
