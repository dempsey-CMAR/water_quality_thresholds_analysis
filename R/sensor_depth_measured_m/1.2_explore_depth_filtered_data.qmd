...
- Don't apply user or climatology thresholds to measured sensor depth data.
  - Depth depends on where the sensor was on the string, not the county or the season.
