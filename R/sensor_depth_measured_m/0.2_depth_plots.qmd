...
- This data is from the reprocessed Coastal Monitoring Program data.
 ...
 - No preliminary QC was applied to this data. 
  - Exception: Olding Island 2022-06-03 measured outside of the sensor gross range and was not plotted here.
...
- VR2 sensors do not record decimal places.
  - Depth range must be consistently >= 2 m to start to pick up tidal cycle (e.g., will record 1 m, 2 m, 3 m)
    - Cornwallis, Fisherman's Island
  - Depth range < 2 m will only show ~ mid tide and the high OR low tide
    - Moose Point, Tanner Island
- Digby
