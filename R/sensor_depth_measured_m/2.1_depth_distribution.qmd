...
#     sd = sd(value)
#   ) %>% 
#   mutate(user_min = mean - 3*sd, user_max = mean + 3 * sd)
...
- User thresholds based on historical data would not be useful at the county or station level because the measured depth depends on where the sensor is placed on the string.
