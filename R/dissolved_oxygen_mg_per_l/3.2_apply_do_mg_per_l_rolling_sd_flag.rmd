...
qc_summary <- dat_qc %>%
  rename(rolling_sd_flag = rolling_sd_flag_dissolved_oxygen_uncorrected_mg_per_l) %>%
...
# QC Flags: Dissolved Oxygen (mg/L), Rolling Standard Deviation
...
#| message: FALSE
  ...
  for(i in seq_along(stations)){
    ...
    for(j in 1:length(deployments)){
      ...
      p <- p$dissolved_oxygen_uncorrected_mg_per_l$rolling_sd
